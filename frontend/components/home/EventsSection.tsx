      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {events.map((event) => (
              <div key={event._id} className="group bg-white rounded-md border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-[#C5A059] transition-colors leading-tight min-h-[3rem]" style={{ fontFamily: 'serif' }}>
                    {event.title}
                  </h3>
                  <div className="flex items-center justify-between mt-6 pt-6 border-t border-gray-100">
                    ...
                    <Link href={`/events/${event._id}`} className="text-[#1A1A1A] font-bold text-[10px] hover:text-[#C5A059] transition-colors flex items-center gap-1 uppercase tracking-[0.2em] group/btn">
